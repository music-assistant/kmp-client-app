...
val primaryLightVariant = Color(0xFF575992)
val onPrimaryLight = Color(0xFFFFFFFF)
val secondaryLight = Color(0xFF5D5C72)
val secondaryLightVariant = Color(0xFF5D5C72)
...
val primaryDarkVariant = Color(0xFFC0C1FF)
val onPrimaryDark = Color(0xFF292A60)
val secondaryDark = Color(0xFFC6C4DD)
val secondaryDarkVariant = Color(0xFFC6C4DD)
