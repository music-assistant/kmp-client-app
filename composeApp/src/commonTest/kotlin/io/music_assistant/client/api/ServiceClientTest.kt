...
class ServiceClientTest {
    ...
    @Test
    fun initialState_shouldBeDisconnectedInitial() = runTest {
        // Given
    ...
    @Test
    fun connect_whenDisconnected_shouldTransitionToConnecting() = runTest {
        // Given
        val settingsRepo = createTestSettingsRepository()
        val serviceClient = ServiceClient(settingsRepo)
    ...
    @Test
    fun connect_whenAlreadyConnecting_shouldIgnore() = runTest {
        // Given
        val settingsRepo = createTestSettingsRepository()
        val serviceClient = ServiceClient(settingsRepo)
    ...
    @Test
    fun disconnectByUser_whenNotConnected_shouldNotChangeState() = runTest {
        // Given
        val settingsRepo = createTestSettingsRepository()
        val serviceClient = ServiceClient(settingsRepo)
    ...
    @Test
    fun sessionState_whenInitialWithConnectionInfo_shouldAttemptReconnect() = runTest {
        // Given
    ...
    @Test
    fun disconnectByUser_whenConnecting_shouldStayInConnectingState() = runTest {
        // Given
        val connectionInfo = ConnectionInfo(host = "localhost", port = 8095, isTls = false)
        val settingsRepo = createTestSettingsRepository(connectionInfo)
    ...
    @Test
    fun sessionState_whenNoServerData_shouldNotReconnect() = runTest {
        // Given
    ...
    @Test
    fun serverInfo_shouldInitiallyBeNull() = runTest {
        // Given
        val settingsRepo = createTestSettingsRepository()
        val serviceClient = ServiceClient(settingsRepo)
    ...
    @Test
    fun sendCommand_createsRequestWithCorrectCommand() = runTest {
        // Given
        val settingsRepo = createTestSettingsRepository()
        val serviceClient = ServiceClient(settingsRepo)
    ...
    @Test
    fun sessionState_transitions_shouldFollowValidFlow() = runTest {
        // Given
        val settingsRepo = createTestSettingsRepository()
        val serviceClient = ServiceClient(settingsRepo)
        val connectionInfo = ConnectionInfo(host = "localhost", port = 8095, isTls = false)
    ...
    @Test
    fun updateConnectionInfo_shouldBeCalled_whenConnected() = runTest {
        // Given
        val settingsRepo = createTestSettingsRepository()
        val serviceClient = ServiceClient(settingsRepo)
