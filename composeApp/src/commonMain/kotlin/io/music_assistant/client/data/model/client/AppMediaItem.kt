...
abstract class AppMediaItem(
    ...
    fun hasAnyMappingFrom(other: AppMediaItem): Boolean = mappingsHashes.intersect(other.mappingsHashes).isNotEmpty()

    override fun equals(other: Any?): Boolean =
        other is AppMediaItem &&
            itemId == other.itemId &&
            name == other.name &&
    ...
    override fun toString(): String =
        "AppMediaItem(itemId='$itemId', provider='$provider', name='$name', favorite=$favorite, mediaType=$mediaType, providerMappings=$providerMappings, uri=$uri)"
...
//                    owner = owner,
        ...
        fun List<ServerMediaItem>.toAppMediaItemList() = mapNotNull { it.toAppMediaItem() }
